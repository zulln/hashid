function CRC16() {
    hs='4607';
    if (hash.length==hs.length && isalpha(hash)==false && isalnum(hash)==true) {
...
function GHash323() {
    hs='80000000';
    if (hash.length==hs.length && !isNaN(hash)==true && isalpha(hash)==false && isalnum(hash)==true) {
...
function LineageIIC4() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==true && hash.substring(0, 2) == '0x'){
...
function MySQL160bit() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==false && hash.substring(0, 1) == '*'){
...
function MD5passsaltjoomla1() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==false && hash.substring(32, 33) == ':'){
...
function SHA1Django() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==false && hash.substring(0, 5) == 'sha1$'){
...
function SAM() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==false && islower(hash)==false && hash.substring(32, 33) == ':'){
...
function SHA256Django() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==false && hash.substring(0, 6) == 'sha256'){
...
function SHA384Django() {
    ...
    if (hash.length==hs.length && !isNaN(hash)==false && isalpha(hash)==false && isalnum(hash)==false && hash.substring(0, 6) == 'sha384'){
